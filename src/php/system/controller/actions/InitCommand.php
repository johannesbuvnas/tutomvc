...
class InitCommand extends ActionCommand
{
	...
	function prepView()
	{
		...
		if( SystemFacade::DEVELOPMENT_MODE )
		{
			...
			wp_register_script( SystemFacade::SCRIPT_JS, $this->getFacade()->getURL( "src/js/Main.config.js" ), array( SystemFacade::SCRIPT_JS_REQUIRE, TutoMVC::NAME ), TutoMVC::VERSION, TRUE );
		}
		else
		{
