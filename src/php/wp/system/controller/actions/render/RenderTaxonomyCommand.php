<?php
	...
	class RenderTaxonomyCommand extends ActionCommand
	{
		...
		function execute()
		{
			...
			$createTermsCapability = Taxonomy::CAPABILITY_CREATE_TERMS;
			$metaField = new MetaField(
				...
				array(
					...
					MetaField::SETTING_INPUT_ON_ENTER => property_exists( $tax->cap, Taxonomy::CAPABILITY_CREATE_TERMS ) ? current_user_can( $tax->cap->$createTermsCapability ) : current_user_can( $tax->cap->manage_terms ),
