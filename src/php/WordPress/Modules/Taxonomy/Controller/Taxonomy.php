<?php
	...
	class Taxonomy extends NameObject
	{
		...
		public function wp_render( $post, $taxonomy )
		{
			...
			// TODO: USE A TAGGABLE SELECT THINGY. USED TO BE Select2.
			$tagSelector = new SelectFormInput( $this->getName(), $taxonomyVO->labels->menu_name, NULL, FALSE, !current_user_can( $taxonomyVO->cap->assign_terms ) );
...
//				) );
		...
		{
			/** @var WPAdminTaxonomyColumn $taxonomyColumn */
		 ...
		 * @param $columnName
		 *
		 * @return null|WPAdminTaxonomyColumn
		 */
