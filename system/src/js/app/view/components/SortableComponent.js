...
function( tutomvc, $ )
{
	...
	return function( element, handleSelector )
	{
		SortableComponent.prototype = new tutomvc.core.controller.event.EventDispatcher();
		SortableComponent.prototype.constructor = SortableComponent;

		return new SortableComponent( element, handleSelector );
	};
});