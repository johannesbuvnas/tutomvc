...
define('text!view/form/MetaBoxListGroup.html',[],function () { return '<li class="list-group-item metabox-list-group-header">\n    <h3>\n        <%= label %>\n        <small class="help-block">\n            <%= description %>\n        </small>\n    </h3>\n</li>\n\n<li class="list-group-item metabox-list-group-top-nav" style="text-align: center">\n    <% if(addOption) { %>\n    <button class="btn btn-primary btn-add">\n        <span class="glyphicon glyphicon-plus"></span>\n    </button>\n    <% } %>\n</li>\n\n<li class="list-group-item metabox-list-group-footer" style="text-align: center">\n    <% if(addOption) { %>\n    <button class="btn btn-primary btn-add">\n        <span class="glyphicon glyphicon-plus"></span>\n    </button>\n    <% } %>\n</li>';});


define('text!view/form/MetaBoxListGroupItem.html',[],function () { return '\n<% if(navEnabled) { %>\n<li class="list-group-item metabox-list-group-item-header disabled">\n    <select class="selectpicker metabox-list-group-item-select-index" data-width="auto" style="display: none;">\n        <%\n        var i = 0;\n        while(i < total)\n        {\n        if(i == index)\n        {\n        %>\n        <option selected value="<%=i%>">#<%=i+1%></option>\n        <%\n        }\n        else\n        {\n        %>\n        <option value="<%=i%>">#<%=i+1%></option>\n        <%\n        }\n        i++;\n        }\n        %>\n    </select>\n    <% if(deleteOption) { %>\n    <button class="btn btn-sm btn-remove btn-danger pull-right">\n        <span class="glyphicon glyphicon-remove"></span>\n    </button>\n    <% } %>\n</li>\n<% } %>\n<li class="list-group-item metabox-list-group-item-body">\n</li>';});

/**
 * Created by johannesbuvnas on 17/01/15.
 */
define( 'view/form/inputs/Input',[
    "backbone"
], function ( Backbone )
{
 ...
 * Created by johannesbuvnas on 17/01/15.
 */
define( 'view/form/MetaBoxListGroupItem',[
        "backbone",
        "underscore",
 ...
 * Created by johannesbuvnas on 17/01/15.
 */
define( 'view/form/MetaBoxListGroup',[
        "backbone",
        "underscore",
