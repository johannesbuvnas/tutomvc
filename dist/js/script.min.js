...
define("../../libs/scripts/underscore/underscore", function(){});

define( 'modules/underscore',[
        "underscore"
    ],
    function ( underscore )
    {
		...
		type: {
			set: function( elem, value ) {
				if ( !jQuery.support.radioValue && value === "radio" && jQuery.nodeName(elem, "input") ) {
					// Settings the type on a radio button after the value resets the value in IE6-9
...
if ( !getSetAttribute ) {
	...
	// Settings to empty string throws an error as an invalid value
	...
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			if ( ( value >= 1 || value === "" ) &&
				...
				// Settings style.filter to null, "" & " " still leave "filter:" in the cssText
...
define("../../libs/scripts/jquery/jquery", function(){});
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('../../libs/scripts/backbone/backbone',['underscore', 'jquery', 'exports'], function(_, $, exports) {
  ...
  // Turn on `emulateHTTP` to support legacy HTTP servers. Settings this option
...
define('text!view/form/ReproducibleFormGroup.html',[],function () { return '<li class="list-group-item reproducible-form-group-header">\n    <h3>\n        <%= label %>\n        <small class="help-block">\n            <%= description %>\n        </small>\n    </h3>\n</li>\n\n<li class="list-group-item reproducible-form-group-top-nav" style="text-align: center">\n    <% if(addOption) { %>\n    <button class="btn btn-primary btn-add">\n        <span class="glyphicon glyphicon-plus"></span>\n    </button>\n    <% } %>\n</li>\n\n<li class="list-group-item reproducible-form-group-footer" style="text-align: center">\n    <% if(addOption) { %>\n    <button class="btn btn-primary btn-add">\n        <span class="glyphicon glyphicon-plus"></span>\n    </button>\n    <% } %>\n</li>';});


define('text!view/form/ReproducibleFormGroupItem.html',[],function () { return '<% if(navEnabled) { %>\n<li class="list-group-item reproducible-form-group-item-header disabled">\n        <select class="reproducible-form-group-item-select-index" data-width="auto">\n            <%\n            var i = 0;\n            while(i < total)\n            {\n            if(i == index)\n            {\n            %>\n            <option selected value="<%=i%>">#<%=i+1%></option>\n            <%\n            }\n            else\n            {\n            %>\n            <option value="<%=i%>">#<%=i+1%></option>\n            <%\n            }\n            i++;\n            }\n            %>\n        </select>\n        <% if(deleteOption) { %>\n        <button class="btn btn-sm btn-remove btn-danger pull-right">\n            <span class="glyphicon glyphicon-remove"></span>\n        </button>\n        <% } %>\n</li>\n<% } %>\n<li class="list-group-item reproducible-form-group-item-body">\n</li>';});

/**
 * Created by johannesbuvnas on 18/01/15.
 */
define( 'view/form/inputs/WPEditor',[
        "jquery",
        "backbone",
        "underscore"
    ],
 ...
 */
define( 'view/form/inputs/FormInput',[
    "backbone",
 ...
 * Created by johannesbuvnas on 17/01/15.
 */
define( 'view/form/ReproducibleFormGroupItem',[
        "backbone",
        "underscore",
 ...
 * Created by johannesbuvnas on 17/01/15.
 */
define( 'view/form/ReproducibleFormGroup',[
        "backbone",
        "underscore",
